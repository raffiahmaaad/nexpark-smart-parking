...
<div class="modal fade" id="delete{{ $key }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content nexpark-delete-modal-card">
            <form action="{{ route('backend.vehicles.destroy', $vehicle->id) }}" method="POST">
                @csrf
                @method('DELETE')
                ...
                <div class="modal-body text-center py-5 nexpark-delete-modal-body">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <p class="mb-1" style="color:#444; font-size:0.96rem;">Apakah Anda yakin ingin menghapus
                            kendaraan berikut?</p>
                        <div class="mb-3">
                            <span class="badge badge-pill badge-danger px-3 py-2"
                                style="font-size:1.15rem; letter-spacing:0.5px;">{{ $vehicle->name }} -
                                {{ $vehicle->plat_number }}</span>
                        </div>
