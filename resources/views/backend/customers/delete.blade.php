            ...
            <form action="{{ route('backend.customers.destroy', $customer->id) }}" method="POST">
                ...
                <div class="modal-body text-center py-5 nexpark-delete-modal-body">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <h3 class="mb-2 font-weight-bold" style="color:#222; letter-spacing:0.5px;">Hapus Pelanggan</h3>
                        ...
                        <div class="mb-3">
                            <span class="badge badge-pill badge-danger px-3 py-2"
                                style="font-size:1.15rem; letter-spacing:0.5px;">{{ $customer->name }}</span>
                        </div>
    ...
    <style>
        ...
        @media (max-width: 576px) {
            ...
            .nexpark-delete-btn-confirm {
                ...
                /* Remove bottom margin if stacking */
            }
        }
    </style>
@endpush