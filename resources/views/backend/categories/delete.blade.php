...
<div class="modal fade" id="delete{{ $key }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content nexpark-delete-modal-card">
            <form action="{{ route('backend.categories.destroy', $category->cat_id) }}" method="POST">
                @csrf
                @method('DELETE')
                ...
                <div class="modal-body text-center py-5 nexpark-delete-modal-body">
                    <div class="d-flex flex-column align-items-center">
                        <div class="icon-avatar mb-4">
                            <i class="ik ik-box" style="font-size:4.5rem; color:#e53935;"></i>
                        </div>
                        <h3 class="mb-2 font-weight-bold" style="color:#222; letter-spacing:0.5px;">Hapus Kategori</h3>
                        <p class="mb-1" style="color:#444; font-size:1rem;">Apakah Anda yakin ingin menghapus kategori
                            :</p>
                        <div class="mb-3">
                            <span class="badge badge-pill badge-danger px-3 py-2"
                                style="font-size:1.15rem; letter-spacing:0.5px;">{{ $category->name }}</span>
                        </div>
