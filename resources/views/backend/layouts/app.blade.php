                ...
                <div class="modal-body d-flex align-items-center">
                    <div class="container">
                        <div class="apps-wrap">
                            ...
                            <div class="app-item">
                                <a href="#"><i class="ik ik-users"></i><span>Akun</span></a>
                            </div>
                            <div class="app-item">
                            ...
                            <div class="app-item">
                                <a href="#"><i class="ik ik-server"></i><span>Menu</span></a>
                            </div>
                            <div class="app-item">
                                <a href="#"><i class="ik ik-clipboard"></i><span>Halaman</span></a>
                            </div>
                            <div class="app-item">
                                <a href="#"><i class="ik ik-message-square"></i><span>Chats</span></a>
                            </div>
                            <div class="app-item">
                                <a href="#"><i class="ik ik-map-pin"></i><span>Kontak</span></a>
                            </div>
                            <div class="app-item">
